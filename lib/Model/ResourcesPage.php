    ...
    */
    ...
    public function setPreviousPageToken($previous_page_token)
    {
        ...
        if ((mb_strlen($previous_page_token) < 1)) {
            throw new \InvalidArgumentException('invalid length for $previous_page_token when calling ResourcesPage., must be bigger than or equal to 1.');
        }
    ...
    public function setNextPageToken($next_page_token)
    {
        ...
        if ((mb_strlen($next_page_token) < 1)) {
            throw new \InvalidArgumentException('invalid length for $next_page_token when calling ResourcesPage., must be bigger than or equal to 1.');
        }
