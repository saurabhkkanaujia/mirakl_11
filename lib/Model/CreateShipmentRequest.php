...
class CreateShipmentRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'items' => '\Ced\MiraklApi\Model\CreateShipmentItemRequest[]',
        'carrier' => 'string',
    ...
    */
     ...
     * Gets items
     *
     * @return \Ced\MiraklApi\Model\CreateShipmentItemRequest[]|null
     */
     ...
     * Sets items
     *
     * @param \Ced\MiraklApi\Model\CreateShipmentItemRequest[]|null $items Shipment items
     *
     * @return self
     */
    ...
    public function setTrackingNumber($tracking_number)
    {
        ...
        if ((mb_strlen($tracking_number) < 1)) {
            throw new \InvalidArgumentException('invalid length for $tracking_number when calling CreateShipmentRequest., must be bigger than or equal to 1.');
        }
