...
/**
     ...
     * @param  \Ced\MiraklApi\Model\AcceptOrderLinesRequest $accept_order_lines_request accept_order_lines_request (required)
     ...
     *
     * @param  string $order_id Order identifier in Mirakl Connect (required)
     * @param  \Ced\MiraklApi\Model\AcceptOrderLinesRequest $accept_order_lines_request (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['acceptOrderLines'] to see the possible values for this operation
     *
     * @throws \Ced\MiraklApi\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     ...
     * @throws \Ced\MiraklApi\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Ced\MiraklApi\Model\OrdersPageResponse
     */
     ...
     * @throws \Ced\MiraklApi\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Ced\MiraklApi\Model\OrdersPageResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function listOrdersWithHttpInfo($associative_array)
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Ced\MiraklApi\Model\OrdersPageResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\Ced\MiraklApi\Model\OrdersPageResponse' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\Ced\MiraklApi\Model\OrdersPageResponse', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = '\Ced\MiraklApi\Model\OrdersPageResponse';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Ced\MiraklApi\Model\OrdersPageResponse',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
