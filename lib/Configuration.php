...
class Configuration
{
    ...
    {
        $report  = 'PHP SDK (Ced\MiraklApi) Debug Report:' . PHP_EOL;
        $report .= '    OS: ' . php_uname() . PHP_EOL;
        $report .= '    PHP Version: ' . PHP_VERSION . PHP_EOL;
        $report .= '    The version of the OpenAPI document: afcae4e6-28a6-4477-a8ed-d78442ed50d5' . PHP_EOL;
    ...
    public function getHostSettings()
    {
        return [
            ...
            [
                "url" => "https://miraklconnect.com/api",
                "description" => "To call Connect APIs, prefix them with the following URL: https://miraklconnect.com/api",
            ]
        ];
    }
